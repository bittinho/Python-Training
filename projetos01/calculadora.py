...
def popupmsg():
    ...
    B1 = Button(popup, text="Okay", bg="#DDDDDD", comand=popup.destroy)
    B1.pack()
...
def cal():
    ...
    entry.grid(row=0, column=0, columnspan=4, stick=N + W + S + E, padx=5, pady=5)
    ...
    button15.grid(row=1, column=0, columnspan=2, padx=3, pady=5, stick=N + S + E + W)
